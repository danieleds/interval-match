...
export const test_data_1: {v1: Rule[], v2: Interval[], r: Map<string, Interval|SpaceInterval>}[] = [
    ...
    },
    {
        ...
        r: new Map<string, Interval|SpaceInterval>([["A", {from: 50, to: 60, data: 'u'}], ["B", {from: 60, to: 65, data: undefined!, isSpace: true}]])
    },
    {
        ...
        r: new Map<string, Interval|SpaceInterval>([["A", {from: 7, to: 12, data: 'u'}], ["B", {from: 12, to: 15, data: undefined!, isSpace: true}], ["C", {from: 15, to: 18, data: 'x'}]])
    },
    {
        v1: [{interval: {name: "A", from: {lowerBound: 7, upperBound: 9}, to: null, minSize: 1, maxSize: 8}, followingSpace: {name: "B", minSize: 0.5, maxSize: 4}},
                            {interval: {name: "C", from: null, to: {lowerBound: null, upperBound: 20}, minSize: 1, maxSize: 8}, followingSpace: null}],
    ...
    },
    {
        ...
        r: new Map<string, Interval|SpaceInterval>([["A", {from: 25, to: 30, data: 'x'}], ["B", {from: 30, to: 40, data: undefined!, isSpace: true}]])
    },
    {
    ...
    { // followingSpace should be half the size of its preceding interval. Intervals match.
        ...
        r: new Map<string, Interval|SpaceInterval>([["A", {from: 40, to: 60, data: 'u'}], ["B", {from: 60, to: 70, data: undefined!, isSpace: true}]])
    },
