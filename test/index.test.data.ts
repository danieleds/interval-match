...
export const test_data_1: {v1: Pattern, v2: Interval[], r: Result}[] = [
    {
        v1: { constraints: [{interval: {name: "A", from: null, to: null, minSize: 500, maxSize: 1000}, followingSpace: null}] },
    ...
    {
        v1: { constraints: [{interval: {name: "A", from: {lowerBound: 100, upperBound: 150}, to: null, minSize: 0, maxSize: Infinity}, followingSpace: null}] },
    ...
    {
        v1: { constraints: [{interval: {name: "A", from: null, to: null, minSize: 0, maxSize: Infinity}, followingSpace: {name: "B", minSize: 5, maxSize: 10}}] },
        v2: [{from: 50, to: 60, data: 'u'}, {from: 65, to: 100, data: 'u'}],
        r: new Map([["A", {from: 50, to: 60, data: 'u'}], ["B", {from: 60, to: 65, data: undefined!}]])
    },
    {
        v1: { constraints: [{interval: {name: "A", from: {lowerBound: 7, upperBound: 9}, to: null, minSize: 1, maxSize: 8}, followingSpace: {name: "B", minSize: 0.5, maxSize: 4}},
    ...
    {
        v1: { constraints: [{interval: {name: "A", from: null, to: null, minSize: 2, maxSize: 20}, followingSpace: {name: "B", minSize: 10, maxSize: Infinity}}] },
